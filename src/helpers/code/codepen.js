...
module.exports = function( chunk, context, bodies, params ) {
	...
	html = "<p data-height=\"" + params.height + "\" data-theme-id=\"0\" data-slug-hash=\"" + params.id + "\" data-default-tab=\"" + params.tab + "\" data-user=\"" + params.user + "\" class=\"codepen helper-media\">See the <a href=\"http://codepen.io/" + params.user + "/pen/" + params.id + "/\">Pen</a> on <a href=\"http://codepen.io\">CodePen</a>.</p>";
